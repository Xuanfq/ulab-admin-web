    ...
    <div class="login-container">
      ...
      <div class="login-box">
        <div class="login-form">
          ...
          <Motion v-if="false && currentPage === 0" :delay="350">
            <el-form-item>
              <el-divider>
          ...
          <!-- 手机号登录 -->
          <phone v-if="(currentPage > 0) && (operates.length > currentPage-1) && operates[currentPage-1].id === 'phone'" />
          <!-- 二维码登录 -->
          <qrCode v-if="(currentPage > 0) && (operates.length > currentPage-1) && operates[currentPage-1].id === 'qrcode'" />
          <!-- 注册 -->
          <register v-if="(currentPage > 0) && (operates.length > currentPage-1) && operates[currentPage-1].id === 'register'" />
          <!-- 忘记密码 -->
